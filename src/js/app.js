...
function render(variables = {}) {
  ...
  if (variables.includeAvatar == false)
    avatar = `<img src ="https://static.vecteezy.com/system/resources/thumbnails/004/640/699/small/circle-upload-icon-button-isolated-on-white-background-vector.jpg">`;
